...
import MeltWater.QuoteExtractionV2.ExtractionAppVersionTwo;
import MeltWater.QuoteExtractionV2.FoundText;

public class ExtractionAppVersionTwoTest {
	ExtractionAppVersionTwo app;

	@Before
	public void setup() {
		app = new ExtractionAppVersionTwo();
	...
	public void testGetQuetes2() throws IOException {
		...
		for (FoundText s : app.getQuotes(input)) {
